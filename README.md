I build production web platforms and AI tools — most recently a multi-tenant website/booking engine serving paying small-business clients, and a self-hosted real-time multiplayer game.
